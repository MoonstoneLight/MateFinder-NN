...
MateFinder-NN is a free, powerful UCI chess engine derived from matefinder ([https://github.com/IIvec/Stockfish/tree/mate_finder.)] I. Ivec author-
...
Chess Partner or Fritz) in order to be used comfortably. Read the documentation for your GUI of choice for information about how to use MateFinder-NN with it.

This version of MateFinder-NN has support for Syzygybases.

### Files

This distribution of MateFinder-NN consists of the following files:
  ...
  * source, a subdirectory containing the full source code, including a Makefile
    that can be used to compile MateFinder-NN on Unix-like systems.
...
- [https://github.com/amchess/BrainLearn] MateFinder-NN implements a persistent learning algorithm, managing a file named experience.bin by Kelly kyniama and Andrea Manzo.
...
When MateFinder-NN starts a new game or when we have max 8 pieces on the chessboard, the learning is activated and the hash table updated each time the engine has a best score
